...
function buildNav(members) {
    ...
    nav += buildMemberNav(members.modules, 'Modulos', {}, linkto);
    nav += buildMemberNav(members.externals, 'Externos', seen, linktoExternal);
    nav += buildMemberNav(members.namespaces, 'Nombre de espacio', seen, linkto);
    nav += buildMemberNav(members.classes, 'Clases', seen, linkto);
    nav += buildMemberNav(members.interfaces, 'Interfaces', seen, linkto);
    nav += buildMemberNav(members.events, 'Eventos', seen, linkto);
    nav += buildMemberNav(members.mixins, 'Mixins', seen, linkto);
    nav += buildMemberNav(members.tutorials, 'Tutoriales', seenTutorials, linktoTutorial);
